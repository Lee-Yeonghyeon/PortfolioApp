...
class PortfolioCalendarViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        calendarView.setOnDateChangeListener { view, year, month, dayOfMonth ->
            ...
            Log.d("myDB", "str_rStartDate= " + str_rStartDate)
            Log.d("myDB", "tvDate= " + tvDate)
            Log.d("myDB", "tvDat2= " + tvDate2)
            ...
            portlistview  = findViewById<ListView>(R.id.recordListView)
        ...
        // 날짜 클릭시 해당하는 활동 출력
        // val intent = intent
        // str_rStartDate = intent.getStringExtra("intent_startDate").toString()
